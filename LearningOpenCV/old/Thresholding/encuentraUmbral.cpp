...
double umbralIdealHist(Mat &I, Mat &Out, unsigned int Limite=15, unsigned int seed = 23094)
{
  Mat H, Clases;
  bool bandera;
...
int main (int argc, char **argv)
{
   ...
   thr = umbralOptimo (I);
   thrHist = umbralIdealHist(I, IumH);
   ...
   cout << "El umbral óptimo calcula con histograma es " << thrHist << endl;
